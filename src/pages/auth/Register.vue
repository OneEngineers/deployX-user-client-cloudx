    ...
    <div
        ...
        <div class="w-full max-w-md">
                ...
                <form @submit.prevent="handleRegister" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="name" v-model="name" type="text" placeholder="John Doe" required
                                ...
                                :class="{ 'border-red-500 focus:ring-red-500': nameError }" @blur="validateName" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" v-model="email" type="email" placeholder="you@example.com" required
                                class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all outline-none"
                                :class="{ 'border-red-500 focus:ring-red-500': emailError }" @blur="validateEmail" />
                        </div>
                    ...
                    <div>
                        ...
                        <ul class="mt-2 space-y-1 text-xs text-gray-600">
                            <li class="flex items-center gap-1" :class="{ 'text-green-600': password.length >= 8 }">
                                <Icon :icon="password.length >= 8 ? 'mdi:check-circle' : 'mdi:circle-outline'"
                                    class="text-sm" />
                                At least 8 characters
                            </li>
                            <li class="flex items-center gap-1" :class="{ 'text-green-600': /[A-Z]/.test(password) }">
                                <Icon :icon="/[A-Z]/.test(password) ? 'mdi:check-circle' : 'mdi:circle-outline'"
                                    class="text-sm" />
                                One uppercase letter
                            </li>
                            <li class="flex items-center gap-1" :class="{ 'text-green-600': /[0-9]/.test(password) }">
                                <Icon :icon="/[0-9]/.test(password) ? 'mdi:check-circle' : 'mdi:circle-outline'"
                                    class="text-sm" />
                                One number
                            </li>
                        </ul>
                        ...
                        <div class="relative">
                            ...
                            <input id="confirmPassword" v-model="confirmPassword"
                                ...
                                :class="{
                                    ...
                                    'border-green-500 focus:ring-green-500': confirmPassword && !confirmPasswordError && password === confirmPassword
            ...
            <p class="text-center text-sm text-gray-600 mt-6">
                ...
                <router-link to="/login" class="text-purple-600 hover:text-purple-700 font-semibold transition-colors">
                    Sign in
                </router-link>
            </p>
        </div>
